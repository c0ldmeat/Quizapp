...
public class question4 extends AppCompatActivity {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (buttonText.equals(this.getString(R.string.nextPage)) && selectedId == R.id.q4a3) {
            ...
            RadioButton radiobuttoncorrect = (RadioButton) findViewById(R.id.q4a3);
