...
public class question6 extends AppCompatActivity {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (buttonText.equals(this.getString(R.string.nextPage)) && selectedId == R.id.q6a3) {
            ...
            RadioButton radiobuttoncorrect = (RadioButton) findViewById(R.id.q6a3);
    ...
    public void submit(View view) {
        ...
        if (radiogroup.getCheckedRadioButtonId() == -1) {// no radio buttons are checked
            ...
            checkAnswers();
            button.setText(this.getString(R.string.lastPage));
        } else if (button.getText().toString().equals(this.getString(R.string.lastPage))) {
