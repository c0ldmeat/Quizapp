...
public class question5 extends AppCompatActivity {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (buttonText.equals(this.getString(R.string.nextPage)) && checkbox2.isChecked() && checkbox4.isChecked() && !checkbox1.isChecked() && !checkbox3.isChecked()) {
            checkbox2.setBackgroundColor(0xff00843b);
